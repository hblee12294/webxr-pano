import { WebGLRenderer, Scene, PerspectiveCamera, GridHelper, AxesHelper } from 'three'
...
export class XRApp {
  ...
  private _onWindowResize = () => {
    ...
    this._renderer.setSize(this._rect.width * pixelRatio, this._rect.height * pixelRatio, false)
  }
}
